...
public class GuiEditTaskMeeting extends GuiScreenCanvas implements IVolatileScreen {
    ...
    public void initPanel() {
        ...
        cvBackground.addPanel(new PanelTextField<>(new GuiTransform(GuiAlign.MID_CENTER, 0, 0, 100, 16, 0), String.valueOf(task.amount), FieldFilterNumber.INT).setCallback(value -> task.amount = value));
