...
public class PanelTabMain extends CanvasEmpty {
    ...
    public void initPanel() {
        ...
        this.addPanel(new PanelButton(new GuiRectangle(0, 0, w / 2, 16, 0), -1, String.valueOf(ToolboxTabMain.INSTANCE.getSnapValue())) {
            @Override
            public void onButtonClick() {
                ToolboxTabMain.INSTANCE.toggleSnap();
                this.setText(String.valueOf(ToolboxTabMain.INSTANCE.getSnapValue()));
            }
